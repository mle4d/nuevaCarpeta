...
document.querySelector('.nintiesPC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/90srepo.gif)';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
...
document.querySelector('.meowPC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/mmrepo.gif)';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
...
document.querySelector('.bookshelfPC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/bookshelfrepo.gif)';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
...
document.querySelector('.spacePC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/sisrepo.gif)';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
