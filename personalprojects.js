document.querySelector('.ballPC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/c8ballrepo.gif) center center';
...
document.querySelector('.bookshelfPC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/bookshelfrepo.gif) center center';
  document.querySelector('.circles').style.display = 'none';
...
document.querySelector('.spacePC').addEventListener('click', function() {
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/sisrepo.gif) center center';
  document.querySelector('.circles').style.display = 'none';
