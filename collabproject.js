document.querySelector('.htsticker').addEventListener('click', function() {
  document.querySelector('.poster').style.background = 'url(assets/happytreesposter.png) center no-repeat #ffffff';
  ...
  document.querySelector('.phone').style.background = 'url(assets/happytreesmobile.jpg) center no-repeat #ffffff';
  document.querySelector('.phone').style.backgroundSize = '100%';
  document.querySelector('#clock').style.display = 'none';
  document.querySelector('#date').style.display = 'none';
  document.querySelector('.screen').style.background = 'url(assets/happytreesdemo.gif) #dedfe4 center no-repeat';
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/happytreesrepo.gif) #24272c center no-repeat';
...
document.querySelector('.moddopc').addEventListener('click', function() {
  document.querySelector('.poster').style.background = 'url(assets/moddoposter.png) center no-repeat #fceff9';
  document.querySelector('.poster').style.backgroundSize = '110%';
  ...
  document.querySelector('#art').style.display = 'none';
  document.querySelector('.phone').style.background = 'url(assets/moddomobile.jpg) center no-repeat #fceff9';
  document.querySelector('.phone').style.backgroundSize = '100%';
  document.querySelector('#clock').style.display = 'none';
  document.querySelector('#date').style.display = 'none';
  document.querySelector('.screen').style.background = 'url(assets/moddodemo.gif) #dedfe4 center no-repeat';
  document.querySelector('.screen').style.backgroundSize = '100%';
  document.querySelector('.dtss').style.display = 'none';
  document.querySelector('.sticky').innerHTML = '<a class="stickyLink" href="https://moddo.netlify.com/index.html" target="_blank">Visit Site</a>';
  document.querySelector('.LTscreen').style.background = 'url(assets/moddorepo.gif) #24272c center no-repeat';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
  document.querySelector('.tab').innerHTML = '<a class="tabLink" href="https://github.com/rubber-ducky-squad/Adviser" target="_blank">See Code</a>';
  window.body
});
document.querySelector('.atbsticker').addEventListener('click', function() {
  document.querySelector('.poster').style.background = 'url(assets/atbposter.png) center no-repeat #ffffff';
  document.querySelector('.poster').style.backgroundSize = '110%';
  ...
  document.querySelector('#art').style.display = 'none';
  document.querySelector('.phone').style.background = 'url(assets/atbmobile.png) center no-repeat #ffffff';
  document.querySelector('.phone').style.backgroundSize = '100%';
  document.querySelector('#clock').style.display = 'none';
  document.querySelector('#date').style.display = 'none';
  document.querySelector('.screen').style.background = 'url(assets/atbdemo.png) #dedfe4 center no-repeat';
  document.querySelector('.screen').style.backgroundSize = '100%';
  document.querySelector('.dtss').style.display = 'none';
  document.querySelector('.sticky').innerHTML = '<a class="stickyLink" href="https://twitter.com/AlchemyPDXBot" target="_blank">Visit Site</a>';
  document.querySelector('.LTscreen').style.background = 'url(assets/atbrepo.gif) #24272c center no-repeat';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
...
document.querySelector('.sotostrip').addEventListener('click', function() {
  document.querySelector('.poster').style.background = 'url(assets/sotoposter.png) center no-repeat #ffffff';
  ...
  document.querySelector('.screen').style.background = 'url(assets/sotodemo.gif) #dedfe4 center no-repeat';
  document.querySelector('.screen').style.backgroundSize = '100%';
  document.querySelector('.dtss').style.display = 'none';
  ...
  document.querySelector('.LTscreen').style.background = 'url(assets/sotorepo.gif) #24272c center no-repeat';
  document.querySelector('.LTscreen').style.backgroundSize = '100%';
  document.querySelector('.circles').style.display = 'none';
